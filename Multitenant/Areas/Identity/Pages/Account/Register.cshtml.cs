...
namespace Multitenant.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    long countUser = _userManager.Users.Count();
                    long count = _context.TenantInfo.Count();
                    long modu = (count % 10);
                    ...
                    _tenantDataService.InsertTanentInfoIntoDynamicDB(tenant);
